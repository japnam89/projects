<%-- 
    Document   : adminReportByFloor
    Created on : Apr 16, 2015, 4:22:02 AM
    Author     : aashishvig
--%>
                                ...
                                <div class="content_section">
                                    <div class="content_section last_section">
                                        ...
                                        <%
                                            ...
                                            List<Rooms> room = br.listBookingbyFloor(f); %>
                                        <form>
                                            <fieldset>
                                                <legend>Booking Report By Floor :</legend>
                                                <%
                                                    for (Rooms rooms : room) { %><br>
                                                ...
                                                <%out.println("Availabilty: " + rooms.getAvailability() + "</br>");
                                                    }%><br>
