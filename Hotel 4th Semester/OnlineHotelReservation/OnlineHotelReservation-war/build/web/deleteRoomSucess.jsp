<%-- 
    Document   : deleteRoomSucess
    Created on : Apr 16, 2015, 4:10:47 AM
    Author     : aashishvig
--%>
...
<div id="slider">
	<div id="tooplate_wrapper">
        ...
        <%
        out.println("</br>"+"</br>"+"Room has been Deleted"+"</br>");
        %>
        <a href="admin.jsp"><input type="submit" value="Insert New Room" name ="sub">
